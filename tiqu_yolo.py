...
parser.add_argument("--model_config_path", type=str, default="config/yolov3_2.cfg", help="path to model config file")
parser.add_argument("--data_config_path", type=str, default="config/coco2.data", help="path to data config file")
parser.add_argument("--weights_path", type=str, default="weights/yolov3.weights", help="path to weights file")
parser.add_argument("--class_path", type=str, default="data/coco2.names", help="path to class label file")
