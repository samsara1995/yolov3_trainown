...
parser.add_argument('--config_path', type=str, default='config/yolov3_2.cfg', help='path to model config file')
parser.add_argument('--weights_path', type=str, default='/nfs/tmp/pycharm_project_350/checkpoints/30.weights', help='path to weights file')
